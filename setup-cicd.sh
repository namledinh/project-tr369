...
echo "• Simple CI (.github/workflows/simple-ci.yml) - Basic test and build"
...
echo ""
print_info "Advanced CI workflow is available but disabled:"
echo "• Full CI Pipeline (.github/workflows/ci.yml.disabled) - Can be enabled later"
